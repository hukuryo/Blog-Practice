                ...
                <div className="shadow-lg h-full px-3 py-4 overflow-y-auto bg-indigo-100 dark:bg-gray-800">
                    <div id="dropdown-cta" className="p-4 mt-5 mb-5 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
                        ...
                        <div className='mb-10 mt-10 flex items-center justify-center '>
                            <button className="shadow-lg hover:bg-gray-400 bg-gray-500 shadow-gray-500/50 text-white rounded px-2 py-1">
                                <Link className="text-xs" href="/profile">プロフィール</Link>
                            </button>
                        </div>
                        <div className='flex justify-center'>
                            <a href="https://github.com/hukuryo" className='mr-5 '>
                            ...
                            <a href="https://twitter.com/hukuryo_">
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            <span className="flex-1 ml-3 dark:text-white whitespace-nowrap">GitHub</span>
                            </a>
                        </li>
                        <li>
