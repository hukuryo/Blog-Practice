            ...
            <main className="md:container md:mx-auto">
                <div className="flex flex-row-reverse">
                    ...
                    <div className="mt-16 ml-16 w-full rounded-md">
                        ...
                        <div className="mt-32">
                            <div className="border border-slate-300 h-80 w-5/6 px-8 pt-8 mb-10">
                                <h5 className="text-center mb-7 font-bold">経歴紹介</h5>
                                <p className="mb-5 border-b-8">2021/4~鉄道会社に就職</p>
                                <p className="mb-5 border-b-8">2022/11~エンジニアに転職</p>
